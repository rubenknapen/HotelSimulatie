...
public class PersonFactory {
	...
	public static Person createPerson(String personType, String status, boolean visibility, int roomId, int x, int y){

	      if(personType == null){
	         return null;
	      }
	      if(personType.equalsIgnoreCase("GUEST")) {
	    	  return new Guest(status, visibility, roomId, x, y);
	      } 
