...
public class HotelEventManager implements Runnable {
    ...
    public HotelEventManager() {
        ...
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 2, new HashMap<String, String>() {{
            put("Guest: 2", "2 stars");
        }}));
        ...
        events.add(new HotelEvent(HotelEventType.CLEANING_EMERGENCY, "", 18, new HashMap<String, String>() {{
            put("Guest", "7");
        }}));
        ...
        events.add(new HotelEvent(HotelEventType.NEED_FOOD, "", 22, new HashMap<String, String>() {{
            put("Guest", "2");
        }}));
        ...
        events.add(new HotelEvent(HotelEventType.CHECK_IN, "", 35, new HashMap<String, String>() {{
        ...
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 40, new HashMap<String, String>() {{
            put("Guest", "5");
        }}));
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 42, new HashMap<String, String>() {{
            put("Guest", "6");
        }}));
        ...
        events.add(new HotelEvent(HotelEventType.START_CINEMA, "", 60, new HashMap<String, String>() {{
            put("ID", "3");
        }}));
        ...
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 66, new HashMap<String, String>() {{
            put("Guest", "2");
        }}));
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 67, new HashMap<String, String>() {{
            put("Guest", "3");
        }}));
        events.add(new HotelEvent(HotelEventType.CHECK_OUT, "", 68, new HashMap<String, String>() {{
            put("Guest", "4");
        }}));

        events.add(new HotelEvent(HotelEventType.CLEANING_EMERGENCY, "", 70, new HashMap<String, String>() {{
            put("Guest", "11");
        }}));

        events.add(new HotelEvent(HotelEventType.CHECK_IN, "", 74, new HashMap<String, String>() {{
            put("Guest: 13", "4 stars");
        }}));
        events.add(new HotelEvent(HotelEventType.CHECK_IN, "", 75, new HashMap<String, String>() {{
            put("Guest: 14", "4 stars");
        }}));


        events.add(new HotelEvent(HotelEventType.EVACUATE, "Fire panic everyone out", 85, new HashMap<String, String>() {{
